...
class Info(commands.Cog):
    ...
    async def about(self, interaction: discord.Interaction):
        ...
        embed.description = (
            ...
            "If you would like to add your own micronation ball, for example representing your micronation, "
            "please go to our support server and make a new request under suggestions!\n"
